...
function Puzzle(id,puzzleOptions) {
	...
	this.draw = function(clip) {
		...
		ctx.save();
		_img = new Image();
		_img.src = 'https://i.imgur.com/blQOfAj.png';
		var _pattern = ctx.createPattern(_img, 'repeat'); // Create a pattern with this image, and set it to "repeat".
		ctx.fillStyle = _pattern;

		// _cxt.fillRect(0, 0, _canvas.width, _canvas.height);
